...
# Code from https://github.com/tensorflow/tensor2tensor/blob/master/tensor2tensor/data_generators/text_encoder_build_subword.py
...
# def create_wordpieces_from_subword_file(subword_filepath):
#   with open(subword_filepath.split('/')[:-1].join(), 'r') as wordpiece_file:
#     with open(subword_filepath, 'r') as subword_file:
#       for word in subword_file.readlines():
